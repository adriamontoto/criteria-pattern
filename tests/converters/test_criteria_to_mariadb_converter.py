"""
Test CriteriaToMariadbConverter class.
"""
...
def assert_valid_mariadb_syntax(*, query: str, parameters: list[Any]) -> None:
    """
    Helper function to validate that the generated SQL query is valid MariaDB syntax using sqlglot.
    ...
    Raises:
        AssertionError: If the query is not valid MariaDB syntax.
    """
    ...
    try:
        ...
        raise AssertionError('Invalid MariaDB syntax.') from exception
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_empty_criteria_and_all_columns() -> None:
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_empty_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with an empty Criteria object.
    """
    query, parameters = CriteriaToMariadbConverter.convert(
        criteria=CriteriaMother.empty(),
        table='user',
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_equal_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with an EQUAL filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_equal_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT EQUAL filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_greater_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a GREATER filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_greater_or_equal_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a GREATER OR EQUAL filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_less_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a LESS filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_less_or_equal_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a LESS OR EQUAL filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_like_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a LIKE filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_like_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT LIKE filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_contains_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a CONTAINS filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_contains_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT CONTAINS filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_starts_with_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a STARTS WITH filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_starts_with_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT STARTS WITH filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_ends_with_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a ENDS WITH filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_ends_with_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT ENDS WITH filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_between_filter_list() -> None:
    """
    Test CriteriaToMariadbConverter class with a BETWEEN filter using a list of values.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_between_filter_tuple() -> None:
    """
    Test CriteriaToMariadbConverter class with a BETWEEN filter using a tuple of values.
    """
    filter = Filter(field='age', operator=Operator.BETWEEN, value=(18, 30))
    query, parameters = CriteriaToMariadbConverter.convert(
        criteria=CriteriaMother.with_filters(filters=[filter]),
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_between_filter_list() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT BETWEEN filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_between_filter_tuple() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT BETWEEN filter using a tuple of values.
    """
    filter = Filter(field='age', operator=Operator.NOT_BETWEEN, value=(18, 30))
    query, parameters = CriteriaToMariadbConverter.convert(
        criteria=CriteriaMother.with_filters(filters=[filter]),
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_is_null_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with an IS NULL filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_is_not_null_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with an IS NOT NULL filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_in_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with an IN filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_in_filter() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT IN filter.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_and_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with an AND Criteria object.
    """
    ...
    assert_valid_mariadb_syntax(query=query1, parameters=parameters1)
    assert query2 == 'SELECT * FROM `user` WHERE (`email` IS NOT NULL AND `name` = %s);'
    assert parameters2 == ['John Doe']
    assert_valid_mariadb_syntax(query=query2, parameters=parameters2)


@mark.unit_testing
def test_criteria_to_mariadb_converter_with_or_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with an OR Criteria object.
    """
    filter1 = Filter(field='name', operator=Operator.EQUAL, value='John Doe')
    filter2 = Filter(field='email', operator=Operator.IS_NOT_NULL, value=None)
    criteria1 = CriteriaMother.with_filters(filters=[filter1])
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_not_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with a NOT Criteria object.
    """
    filter = Filter(field='name', operator=Operator.EQUAL, value='John Doe')
    criteria = CriteriaMother.with_filters(filters=[filter])
    query, parameters = CriteriaToMariadbConverter.convert(
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_asc_order() -> None:
    """
    Test CriteriaToMariadbConverter class with an ASC order.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_desc_order() -> None:
    """
    Test CriteriaToMariadbConverter class with a DESC order.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_multiple_orders_on_the_same_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with multiple orders on the same Criteria object.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_multiple_orders_on_different_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with multiple orders on different Criteria objects.
    """
    order1 = Order(field='name', direction=Direction.ASC)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filtered_and_ordered_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with a filtered and ordered Criteria object.
    """
    filter1 = Filter(field='name', operator=Operator.EQUAL, value='John Doe')
    filter2 = Filter(field='email', operator=Operator.IS_NOT_NULL, value=None)
    filter3 = Filter(field='age', operator=Operator.LESS, value=18)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_columns_mapping() -> None:
    """
    Test CriteriaToMariadbConverter class with columns mapping.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_columns_mapping_with_spaces() -> None:
    """
    Test CriteriaToMariadbConverter class with columns mapping with spaces.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_table_injection_check_disabled() -> None:
    """
    Test CriteriaToMariadbConverter class with table injection when check_table_injection is disabled.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_table_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with table injection.
    """
    with assert_raises(
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_without_table_injection() -> None:
    """
    Test CriteriaToMariadbConverter class without table injection.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_column_injection_check_disabled() -> None:
    """
    Test CriteriaToMariadbConverter class with columns injection when check_columns_injection is disabled.
    """
    filter: Filter[Any] = FilterMother.create(operator=Operator.EQUAL)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_column_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with columns injection.
    """
    with assert_raises(
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_column_injection_with_star_valid() -> None:
    """
    Test CriteriaToMariadbConverter class with columns injection where columns attribute is a star and is valid.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_column_injection_with_star_and_columns() -> None:
    """
    Test CriteriaToMariadbConverter class with columns injection with star and columns.
    """
    with assert_raises(
        expected_exception=InvalidColumnError,
        match=r'Invalid column specified <<<evil>>>. Valid columns are <<<id, name>>>.',
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_column_mapping_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with columns injection.
    """
    with assert_raises(
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filter_field_injection_check_disabled() -> None:
    """
    Test CriteriaToMariadbConverter class with filter field injection when check_criteria_injection is disabled.
    """
    filter: Filter[Any] = FilterMother.create(field='id; DROP TABLE user;', operator=Operator.EQUAL)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filter_field_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with filter field injection.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filter_value_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with filter value injection.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_order_field_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with order field injection.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_two_order_fields_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with order field injection.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_operator_injection_check_disabled() -> None:
    """
    Test CriteriaToMariadbConverter class with operator injection when check_operator_injection is disabled.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_operator_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with operator injection.
    """
    filter: Filter[Any] = FilterMother.create(operator=Operator.EQUAL)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_valid_operator() -> None:
    """
    Test CriteriaToMariadbConverter class with valid operator.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_multiple_filters_operator_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with multiple filters where one has invalid operator.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_complex_criteria_operator_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with complex criteria containing invalid operator.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_direction_injection_check_disabled() -> None:
    """
    Test CriteriaToMariadbConverter class with direction injection when check_direction_injection is disabled.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_direction_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with direction injection.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_valid_direction() -> None:
    """
    Test CriteriaToMariadbConverter class with valid direction.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_multiple_orders_direction_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with multiple orders where one has invalid direction.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_complex_criteria_direction_injection() -> None:
    """
    Test CriteriaToMariadbConverter class with complex criteria containing invalid direction.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_pagination() -> None:
    """
    Test CriteriaToMariadbConverter class with pagination.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_without_pagination() -> None:
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filters_and_pagination() -> None:
    """
    Test CriteriaToMariadbConverter class with filters and pagination.
    """
    page_size = IntegerMother.positive()
    page_number = IntegerMother.positive()
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_orders_and_pagination() -> None:
    """
    Test CriteriaToMariadbConverter class with orders and pagination.
    """
    page_size = IntegerMother.positive()
    page_number = IntegerMother.positive()
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filters_orders_and_pagination() -> None:
    """
    Test CriteriaToMariadbConverter class with filters, orders, and pagination.
    """
    page_size = IntegerMother.positive()
    page_number = IntegerMother.positive()
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_pagination_first_page() -> None:
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_pagination_second_page() -> None:
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_pagination_with_combined_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with pagination using combined criteria.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_page_size_only() -> None:
    """
    Test CriteriaToMariadbConverter generates LIMIT without OFFSET when only page_size is provided.
    """
    page_size = IntegerMother.positive()
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_filters_and_page_size_only() -> None:
    """
    Test CriteriaToMariadbConverter with filters and LIMIT without OFFSET.
    """
    filter: Filter[Any] = FilterMother.create(operator=Operator.EQUAL)
    page_size = IntegerMother.positive()
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_orders_and_page_size_only() -> None:
    """
    Test CriteriaToMariadbConverter with orders and LIMIT without OFFSET.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_multiple_filters_in_same_criteria() -> None:
    """
    Test CriteriaToMariadbConverter class with multiple filters in the same Criteria object.
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_and_criteria_pagination_left_has_right_none() -> None:
    """
    Test CriteriaToMariadbConverter with AndCriteria where left has pagination, right has none.
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_and_criteria_pagination_left_none_right_has() -> None:
    """
    Test CriteriaToMariadbConverter with AndCriteria where left has no pagination, right has pagination.
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_and_criteria_pagination_both_have() -> None:
    """
    Test CriteriaToMariadbConverter with AndCriteria where both have pagination.
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_and_criteria_pagination_both_none() -> None:
    """
    Test CriteriaToMariadbConverter with AndCriteria where neither has pagination.
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_or_criteria_pagination_left_has_right_none() -> None:
    """
    Test CriteriaToMariadbConverter with OrCriteria where left has pagination, right has none.
    Should use left pagination.
    """
    left_criteria = Criteria(
        filters=[Filter(field='age', operator=Operator.GREATER, value=18)],
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_or_criteria_pagination_left_none_right_has() -> None:
    """
    Test CriteriaToMariadbConverter with OrCriteria where left has no pagination, right has pagination.
    Should fallback to right pagination (NEW BEHAVIOR).
    """
    left_criteria = Criteria(filters=[Filter(field='age', operator=Operator.GREATER, value=18)])
    right_criteria = Criteria(
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_pagination_bounds_check_disabled() -> None:
    """
    Test CriteriaToMariadbConverter with pagination bounds check disabled (should not raise).
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_page_size_bounds_exceeded() -> None:
    """
    Test CriteriaToMariadbConverter raises PaginationBoundsError when page_size exceeds limit.
    """
    page_size = IntegerMother.positive()
    page_number = IntegerMother.positive()
    criteria = Criteria(page_size=page_size, page_number=page_number)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_page_number_bounds_exceeded() -> None:
    """
    Test CriteriaToMariadbConverter raises PaginationBoundsError when page_number exceeds limit.
    """
    page_size = IntegerMother.positive()
    page_number = IntegerMother.positive()
    criteria = Criteria(page_size=page_size, page_number=page_number)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_valid_pagination_bounds() -> None:
    """
    Test CriteriaToMariadbConverter with valid pagination parameters within bounds.
    """
    page_size = IntegerMother.positive()
    page_number = IntegerMother.positive()
    criteria = Criteria(page_size=page_size, page_number=page_number)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_with_none_pagination_bounds_check() -> None:
    """
    Test CriteriaToMariadbConverter with no pagination and bounds checking enabled.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_escape_like_pattern_value_escapes_wildcards() -> None:
    """
    Test MariaDB converter escapes SQL wildcard characters in LIKE pattern values.
    """
    assert CriteriaToMariadbConverter._escape_like_pattern_value(value='100%_off') == '100\\%\\_off'


@mark.unit_testing
def test_criteria_to_mariadb_converter_escapes_like_wildcards_in_contains_query() -> None:
    """
    Test MariaDB converter escapes wildcard characters for CONTAINS filters.
    """
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_quote_backtick_identifier_escapes_embedded_backticks() -> None:
    """
    Test MariaDB converter escapes embedded backticks in identifiers.
    """
    assert CriteriaToMariadbConverter._quote_backtick_identifier(identifier='id` OR 1=1 --') == '`id`` OR 1=1 --`'


@mark.unit_testing
def test_criteria_to_mariadb_converter_convert_escapes_embedded_backticks_in_generated_sql() -> None:
    """
    Test MariaDB converter escapes backticks in identifiers used in generated SQL.
    """
    malicious = 'id` OR 1=1 --'
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_rejects_deep_criteria_composition() -> None:
    """
    Test MariaDB converter rejects criteria trees deeper than the configured maximum.
    """
    nested = Criteria(filters=[Filter(field='name', operator=Operator.EQUAL, value='Doe')])
    for _ in range(CriteriaToMariadbConverter.DEFAULT_MAX_CRITERIA_COMPOSITION_DEPTH + 1):
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_rejects_default_max_page_size() -> None:
    """
    Test MariaDB converter applies default pagination maxima when bounds checking is enabled.
    """
    criteria = Criteria(page_size=CriteriaToMariadbConverter.DEFAULT_MAX_PAGE_SIZE + 1, page_number=1)

    with assert_raises(
        expected_exception=PaginationBoundsError,
        match=f'exceeds maximum allowed value <<<{CriteriaToMariadbConverter.DEFAULT_MAX_PAGE_SIZE}>>>',
    ):
        CriteriaToMariadbConverter.convert(
            criteria=criteria,
            table='users',
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_validate_criteria_rejects_unmapped_sql_column() -> None:
    """
    Test MariaDB converter rejects mapped SQL columns that are not allowlisted.
    """
    ...
    with assert_raises(
        ...
        CriteriaToMariadbConverter._validate_criteria(
            criteria=criteria,
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_and_criteria_depth_counts_boolean_nodes() -> None:
    """
    Test MariaDB converter measures composed criteria depth on boolean nodes only.
    """
    ...
    assert CriteriaToMariadbConverter._criteria_composition_depth(criteria=composed) == 1


@mark.unit_testing
def test_criteria_to_mariadb_converter_rejects_large_operator_allowlist() -> None:
    """
    Test MariaDB converter rejects explicit operator allowlists above the configured maximum.
    """
    operators = [Operator.EQUAL] * (CriteriaToMariadbConverter.DEFAULT_MAX_OPERATOR_ALLOWLIST + 1)
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_rejects_large_not_in_list_in_composed_criteria() -> None:
    """
    Test MariaDB converter rejects NOT IN lists above the limit inside composed criteria.
    """
    large_values = list(range(CriteriaToMariadbConverter.DEFAULT_MAX_IN_VALUES + 1))
    ...
    with assert_raises(
        ...
        CriteriaToMariadbConverter.convert(
            criteria=criteria,
            table='users',
            max_in_values=CriteriaToMariadbConverter.DEFAULT_MAX_IN_VALUES,
            check_table_injection=False,
            check_column_injection=False,
            check_criteria_injection=False,
            check_operator_injection=False,
...
@mark.unit_testing
def test_criteria_to_mariadb_converter_ignores_non_list_in_values_during_bounds_check() -> None:
    """
    Test MariaDB converter skips IN bounds checks when the filter value is not a list or tuple.
    """
    criteria = Criteria(filters=[Filter(field='status', operator=Operator.IN, value='active')])

    CriteriaToMariadbConverter._ensure_criteria_in_list_sizes(
        criteria=criteria,
        limit=CriteriaToMariadbConverter.DEFAULT_MAX_IN_VALUES,
    )
