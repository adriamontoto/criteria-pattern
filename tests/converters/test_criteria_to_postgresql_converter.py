...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_and_criteria_empty_left() -> None:
    """
    Test CriteriaToPostgresqlConverter class with an AND Criteria where left side is empty.
    """
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_and_criteria_empty_right() -> None:
    """
    Test CriteriaToPostgresqlConverter class with an AND Criteria where right side is empty.
    """
    empty_criteria = Criteria()
    filter = Filter(field='name', operator=Operator.EQUAL, value='John Doe')
    criteria_with_filter = CriteriaMother.with_filters(filters=[filter])
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_and_criteria_both_empty() -> None:
    """
    Test CriteriaToPostgresqlConverter class with an AND Criteria where both sides are empty.
    """
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_or_criteria_empty_left() -> None:
    """
    Test CriteriaToPostgresqlConverter class with an OR Criteria where left side is empty.
    """
    empty_criteria = Criteria()
    filter = Filter(field='name', operator=Operator.EQUAL, value='John Doe')
    criteria_with_filter = CriteriaMother.with_filters(filters=[filter])
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_or_criteria_empty_right() -> None:
    """
    Test CriteriaToPostgresqlConverter class with an OR Criteria where right side is empty.
    """
    empty_criteria = Criteria()
    filter = Filter(field='name', operator=Operator.EQUAL, value='John Doe')
    criteria_with_filter = CriteriaMother.with_filters(filters=[filter])
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_or_criteria_both_empty() -> None:
    """
    Test CriteriaToPostgresqlConverter class with an OR Criteria where both sides are empty.
    """
    empty_criteria1 = Criteria()
    empty_criteria2 = Criteria()
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_not_empty_criteria() -> None:
    """
    Test CriteriaToPostgresqlConverter class with a NOT of empty Criteria.
    """
    empty_criteria = Criteria()
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_complex_empty_combination() -> None:
    """
    Test CriteriaToPostgresqlConverter with complex combinations including empty criteria.
    This replicates the issue from main.py.
    """
    criteria = Criteria()
    ...
    match_by_organization = Criteria(
        filters=[Filter(field='organization_identifier', operator=Operator.EQUAL, value='test')], orders=orders
    )
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_nested_empty_and_criteria() -> None:
    """
    Test CriteriaToPostgresqlConverter with nested AND where both sides are empty.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_nested_empty_or_criteria() -> None:
    """
    Test CriteriaToPostgresqlConverter with nested OR where both sides are empty.
    This forces the recursive processor to hit the branch where both conditions are empty.
    """
    empty_criteria1 = Criteria()
    empty_criteria2 = Criteria()
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_nested_empty_not_criteria() -> None:
    """
    Test CriteriaToPostgresqlConverter with nested NOT of empty criteria.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_with_multiple_filters_in_same_criteria() -> None:
    """
    Test CriteriaToPostgresqlConverter class with multiple filters in the same Criteria object.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_and_criteria_pagination_left_has_right_none() -> None:
    """
    Test CriteriaToPostgresqlConverter with AndCriteria where left has pagination, right has none.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_and_criteria_pagination_left_none_right_has() -> None:
    """
    Test CriteriaToPostgresqlConverter with AndCriteria where left has no pagination, right has pagination.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_and_criteria_pagination_both_have() -> None:
    """
    Test CriteriaToPostgresqlConverter with AndCriteria where both have pagination.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_and_criteria_pagination_both_none() -> None:
    """
    Test CriteriaToPostgresqlConverter with AndCriteria where neither has pagination.
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_or_criteria_pagination_left_has_right_none() -> None:
    """
    Test CriteriaToPostgresqlConverter with OrCriteria where left has pagination, right has none.
    Should use left pagination.
    """
    left_criteria = Criteria(
        filters=[Filter(field='age', operator=Operator.GREATER, value=18)],
...
@mark.unit_testing
def test_criteria_to_postgresql_converter_or_criteria_pagination_left_none_right_has() -> None:
    """
    Test CriteriaToPostgresqlConverter with OrCriteria where left has no pagination, right has pagination.
    Should fallback to right pagination (NEW BEHAVIOR).
    """
    left_criteria = Criteria(filters=[Filter(field='age', operator=Operator.GREATER, value=18)])
    right_criteria = Criteria(
